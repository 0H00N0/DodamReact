...
export default function OrderExchanges() {
  ...
  const [modal, setModal] = useState(null); // { renNum, newPronum:'', reason:'' }
  ...
  const onExchange = (r) => setModal({ renNum: r.rentNum, newPronum:'', reason:'' });
        ...
        <div style={{
          ...
          <div style={{ background:'#fff', padding:20, borderRadius:8, width:420 }}>
            ...
            <div style={{marginTop:12}}>
              ...
              <input value={modal.newPronum} onChange={e=>setModal({...modal, newPronum:e.target.value})}
                     placeholder="예) 101" style={{width:'100%', padding:8}}/>
            </div>
            <div style={{marginTop:12}}>
